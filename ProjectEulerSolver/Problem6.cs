...
namespace ProjectEulerSolver
{
    ...
    public class Problem6 : IProblem
    {
        ...
        {
            return new ProblemDescription ("Sum square difference", 6, "Find the difference between the sum of the squares of the first one hundred natural numbers and the square of the sum.");
        }
    }
